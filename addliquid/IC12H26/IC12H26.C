...
namespace Foam
{
    defineTypeNameAndDebug(IC12H26, 0);
    addToRunTimeSelectionTable(liquidProperties, IC12H26,);
    addToRunTimeSelectionTable(liquidProperties, IC12H26, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::IC12H26::IC12H26()
:
    liquidProperties
    (
        170.338,
...
Foam::IC12H26::IC12H26(const dictionary& dict)
:
    IC12H26()
{
...
void Foam::IC12H26::writeData(Ostream& os) const
{
...
Foam::Ostream& Foam::operator<<(Ostream& os, const IC12H26& l)
{
    l.writeData(os);
    return os;
}
