...
namespace Foam
{
    defineTypeNameAndDebug(NC16H34, 0);
    addToRunTimeSelectionTable(liquidProperties, NC16H34,);
    addToRunTimeSelectionTable(liquidProperties, NC16H34, dictionary);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::NC16H34::NC16H34()
:
    liquidProperties
    (
        226.446,
...
Foam::NC16H34::NC16H34(const dictionary& dict)
:
    NC16H34()
{
...
void Foam::NC16H34::writeData(Ostream& os) const
{
...
Foam::Ostream& Foam::operator<<(Ostream& os, const NC16H34& l)
{
    l.writeData(os);
    return os;
}
