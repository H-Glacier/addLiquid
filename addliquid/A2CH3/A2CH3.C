...
namespace Foam
{
    defineTypeNameAndDebug(A2CH3, 0);
    addToRunTimeSelectionTable(liquidProperties, A2CH3,);
    addToRunTimeSelectionTable(liquidProperties, A2CH3, dictionary);
}
...
Foam::A2CH3::A2CH3(const dictionary& dict)
:
    A2CH3()
{
...
void Foam::A2CH3::writeData(Ostream& os) const
{
...
Foam::Ostream& Foam::operator<<(Ostream& os, const A2CH3& l)
{
    l.writeData(os);
    return os;
}
